...
class _AddAttributeAndOptionState extends State<AddAttributeAndOption> {
  ...
  TextEditingController nameAttributeTextEditingController =
                                                                  ...
                                                                  onTap:
                                                                    ...
                                                                    if (response !=
                                                                      ...
                                                                      setState(
                                                                          () {
                                                                        futureAttrList =
                                                                            getAttributesFromApi(token: globals.token);
                                                                      });
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: TextButton(
                            onPressed: () async {
                              dynamic response = await createAttribute(
                                token: globals.token,
                    ...
                    child: Container(
                      ...
                      child: TextButton(
                        onPressed: () async {
                          ...
                          dynamic response = await createOptions(
                                  token: globals.token,
