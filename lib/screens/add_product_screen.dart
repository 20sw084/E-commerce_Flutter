...
import 'package:quickvilla/services/create_simple_product.dart';
import 'package:quickvilla/services/create_variable_product.dart';
                        ...
                        children: [
                          ...
                          Row(
                              ...
                              children: [
                                Expanded(
                                    child: TextField(
                                  decoration:
                                      textInputDecoration(label: 'Name'),
                          ...
                          Row(
                              ...
                              children: [
                                Expanded(
                                  ...
                                  onChanged: (val) {
                                    price = val;
                                    variantPriceTextController.text = val;
                                  },
                                )),
                                const SizedBox(width: 18),
                                Expanded(
                                  ...
                                  decoration:
                                      textInputDecoration(label: 'Sale Price'),
                                  keyboardType: TextInputType.number,
                                  onChanged: (val) {
                                    salePrice = val;
                                    variantSalePriceTextController.text = val;
                                  },
                                )),
                              ]),
                                ...
                                Padding(
                                  ...
                                  child: PrimaryButton(
                                    ...
                                    onTap: () async {
                                      ...
                                      // TODO below line is responsible for delay before loading appears
                                      isLoading = true;
                                      context.loaderOverlay.show();
                                      _variationsList = await fetchAllVariations(token: globals.token, id: _attributeIdList!).whenComplete(() {
                                        isLoading = false;
                                      });
                                      if(!isLoading) {
                                      ...
                                      log("after setting prices and names for variants ${variationsProvider.variationsList}");
                                      setState(() {
                          ...
                          Padding(
                            ...
                            child: Align(
                              ...
                              child: PrimaryButton(
                                  onTap: () async {
                                    // Below is the function to add simple product
                                   if(_productType == ProductType.simple) {
                                     ...
                                     await createVariableProduct(
                                         ...
                                         isFeaturedSelected == true
                                             ? "1"
                                             : "0",
                                         image: productImg, // TODO send list of images
                                         category: selectedCategory,
                                         variations: variationsProvider.variationsList
                                     )
                                         .whenComplete(
                                             () => isLoading = false);
                                     if (!isLoading) {
